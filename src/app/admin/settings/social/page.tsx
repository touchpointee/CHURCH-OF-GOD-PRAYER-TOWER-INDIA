...
export default function SocialSettingsPage() {
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-3xl font-bold text-gray-800">Social Media & Contact Settings</h1>
            <p className="text-gray-500 mt-1">Manage social links and contact phone numbers & emails (shown on the website footer and contact page).</p>
