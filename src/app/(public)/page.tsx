                ...
                <div className="bg-white text-gray-900 rounded-3xl p-8 shadow-2xl max-w-md mx-auto relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="bg-gray-50 rounded-xl p-4 flex items-center gap-6 border border-gray-100">
                      <div className="w-24 h-24 bg-white p-2 rounded-lg border border-gray-200 flex-shrink-0 flex items-center justify-center overflow-hidden">
                        {/* QR Placeholder */}
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 leading-snug">Use any UPI app to scan and donate directly to our church account.</p>
                      </div>
                    </div>
                  </div>
                </div>
